...
import { AlertCircle, Lightbulb, Eye, TrendingUp } from 'lucide-react';
...
export const InsightsStats = ({ total, unread, critical, opportunities }: InsightsStatsProps) => {
  return (
    <div className="grid gap-4 md:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-green-600">{opportunities}</div>
        </CardContent>
      </Card>
    </div>
  );
