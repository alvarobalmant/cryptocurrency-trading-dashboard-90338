-- Fix: Use appointment_date instead of created_at for performed_at in commission_period_services
...
BEGIN
  ...
  -- CORRIGIDO: usar appointment_date ao invés de created_at
  ...
  SELECT
    ...
    a.appointment_date::timestamp with time zone  -- CORRIGIDO: usar appointment_date
  FROM appointments a
